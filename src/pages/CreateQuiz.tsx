...
export default function CreateQuiz() {
  ...
  const isFormValid = prompt.trim() && (sessionType === "personal" || (sessionType === "host" && hostSettings.title.trim()));
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-3">
                    ...
                    <div className="absolute right-3 bottom-3">
                      <button
                        ...
                        className={`flex items-center gap-1.5 px-3 py-1.5 bg-indigo-50 text-indigo-700 rounded-md
                          ...
                          ${isEnhancing || !prompt.trim() ? 'opacity-50 cursor-not-allowed' : 'shadow-sm hover:shadow'}`}
                ...
                <p className="text-xs text-gray-500 italic">
                  Provide a clear description of the quiz you want to create. Use our AI enhancement to improve your prompt.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div
                    onClick={() => prompt.trim() && setSessionType("personal")}
                  ...
                  >
                    <div className="flex items-center">
                      <div className={`flex-shrink-0 inline-flex p-2 rounded-full ${
                        sessionType === "personal" 
                  ...
                  <div
                    onClick={() => prompt.trim() && setSessionType("host")}
                    className={`relative cursor-pointer rounded-lg border p-4 transition-all duration-200 hover:shadow-md ${
                      !prompt.trim() ? 'opacity-50 cursor-not-allowed' : ''
                    } ${
                      sessionType === "host"
                ...
                <div className="space-y-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setHostSettings(prev => ({ ...prev, totalSpots: parseInt(e.target.value) || 10 }))}
                      min="1"
                      max="50"
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    />
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) => setHostSettings(prev => ({ ...prev, durationMinutes: parseInt(e.target.value) || 30 }))}
                      min="5"
                      max="180"
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    />
